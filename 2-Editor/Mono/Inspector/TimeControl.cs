...
namespace UnityEditor
{
	internal class TimeControl
	{
		...
		public void DoTimeControl(Rect rect)
		{
			...
			Handles.DrawLine (new Vector2 (normalizedPosition, scrubberRect.yMin), new Vector2 (normalizedPosition, scrubberRect.yMax));
			Handles.DrawLine (new Vector2 (normalizedPosition + 1, scrubberRect.yMin), new Vector2 (normalizedPosition + 1, scrubberRect.yMax));
		}
