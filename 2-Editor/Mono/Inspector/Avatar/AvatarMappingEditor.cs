...
namespace UnityEditor
{
	...
	internal class AvatarMappingEditor : AvatarSubEditor
	{
		...
		{
			new int[]{-1},
			new int[]{ (int)HumanBodyBones.Hips, (int)HumanBodyBones.Spine, (int)HumanBodyBones.Chest},
			...
			new int[]
			{
				 (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.ThumbProximal , (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.ThumbIntermediate, (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.ThumbDistal,
				 (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.IndexProximal , (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.IndexIntermediate, (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.IndexDistal, 
				 (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.MiddleProximal , (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.MiddleIntermediate, (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.MiddleDistal,
				 (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.RingProximal , (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.RingIntermediate, (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.RingDistal,
				 (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.LittleProximal , (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.LittleIntermediate, (int)HumanBodyPart.LeftFingerStart + (int)HumanFingerBones.LittleDistal
			}, 
			...
			new int[]
			{
				 (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.ThumbProximal , (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.ThumbIntermediate, (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.ThumbDistal,
				 (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.IndexProximal , (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.IndexIntermediate, (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.IndexDistal, 
				 (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.MiddleProximal , (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.MiddleIntermediate, (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.MiddleDistal,
				 (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.RingProximal , (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.RingIntermediate, (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.RingDistal,
				 (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.LittleProximal , (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.LittleIntermediate, (int)HumanBodyPart.RightFingerStart + (int)HumanFingerBones.LittleDistal
			},
		...
		public override void OnInspectorGUI ()
		{
			...
			GUILayout.BeginVertical ();
			{
				EditorGUI.BeginChangeCheck ();
					...
					{
						m_BodyView = AvatarControl.ShowBoneMapping (m_BodyView, new AvatarControl.BodyPartFeedback (this.IsValidBodyPart), m_Bones, serializedObject);
				...
				if (m_BodyPartToggle[i])
				{
					...
					if (m_BodyPartFoldout[i])
					{
						for (int j = 0; j < m_BodyPartHumanBone[i].Length; j++)
						{
							...
							bone.BoneDotGUI(new Rect(r.x + EditorGUI.indent, r.y - 1, AvatarSetupTool.BoneWrapper.kIconSize, AvatarSetupTool.BoneWrapper.kIconSize), boneIndex, false, false, serializedObject);
		...
		protected BoneState GetBoneState (int i, out string error)
		{
			...
			AvatarSetupTool.BoneWrapper ancestor = m_Bones[AvatarSetupTool.GetFirstHumanBoneAncestor (m_Bones, i)];
		...
		protected void ApplyTemplate ()
		{
			...
			for (int i=0; i<m_Bones.Length; i++)
			{
				...
				{
					Transform transform = modelBones.Keys.First (f => AvatarMappingEditor.MatchName (f.name, boneName));
