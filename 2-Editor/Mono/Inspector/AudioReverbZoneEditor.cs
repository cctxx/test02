...
namespace UnityEditor
{
	...
	class AudioReverbZoneEditor : Editor
	{
		...
		SerializedProperty  m_RoomRolloffFactor; //  like rolloffscale in global settings, but for reverb room size effect
		...
		void OnEnable ()
		{
			...
			m_RoomRolloffFactor = serializedObject.FindProperty("m_RoomRolloffFactor"); //  like rolloffscale in global settings, but for reverb room size effec
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUI.BeginDisabledGroup (m_ReverbPreset.enumValueIndex != 27 || m_ReverbPreset.hasMultipleDifferentValues);
			...
			EditorGUILayout.Slider (m_RoomRolloffFactor, 0.0f, 10.0f);
