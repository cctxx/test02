...
{
	[System.Flags]
	public enum CheckoutMode { Asset = 1, Meta = 2, Both = 3};

	[System.Flags]
	public enum ResolveMethod { UseMine = 1, UseTheirs = 2, UseMerged };

	[System.Flags]
	public enum MergeMethod { MergeNone = 0, MergeAll = 1, MergeNonConflicting = 2 };
...
public partial class Provider
{
	...
	{
		return Internal_CheckoutIsValid(new Asset[] { asset });
	}
