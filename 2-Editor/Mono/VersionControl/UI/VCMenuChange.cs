...
namespace UnityEditorInternal.VersionControl
{
	...
	public class ChangeSetContextMenu
	{
		...
		static bool DeleteChangeSetTest (int userData)
		{
			...
			bool hasAssets = item != null && item.HasChildren && item.FirstChild.Asset != null && item.FirstChild.Name != "Empty change list";
			return !hasAssets && change.id != "-1" && Provider.DeleteChangeSetsIsValid (set);
		}
