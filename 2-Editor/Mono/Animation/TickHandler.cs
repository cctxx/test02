...
internal class TickHandler
{
	...
	private float[] m_TickModulos = new float[]{}; // array with possible modulo numbers to choose from
	private float[] m_TickStrengths = new float[]{}; // array with current strength of each modulo number
	private int m_SmallestTick = 0; // index of the currently smallest modulo number used to draw ticks
	private int m_BiggestTick = -1; // index of the currently biggest modulo number used to draw ticks
