...
public static class SceneModeUtility
{
	...
	private static HierarchyWindow s_HierarchyWindow = null;
	...
	{
		Object[] wins = Resources.FindObjectsOfTypeAll (typeof (HierarchyWindow));
		HierarchyWindow win = wins.Length > 0 ? (wins[0] as HierarchyWindow) : null;
		if (win)
		{
