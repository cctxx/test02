...
namespace UnityEditor
{
	...
	internal class ListViewGUILayout
	{
		...
		//static ListViewShared.InternalLayoutedListViewState ilvState = new ListViewShared.InternalLayoutedListViewState();
				...
				case EventType.Layout:
					{
						...
						//g.myForcedMinHeight = g.minHeight;
						break;
					}
			}
		}
