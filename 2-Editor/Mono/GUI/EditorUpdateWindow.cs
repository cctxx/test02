...
internal class EditorUpdateWindow : EditorWindow {
	...
	private static void LoadResources ()
	{
		...
		s_Title = EditorGUIUtility.TextContent ("EditorUpdateWindow.Title");

		s_UnityLogo = EditorGUIUtility.IconContent ("UnityLogo");
		s_TextHasUpdate = EditorGUIUtility.TextContent ("EditorUpdateWindow.TextHasUpdate");
		s_TextUpToDate = EditorGUIUtility.TextContent ("EditorUpdateWindow.TextUpToDate");

		s_CheckForNewUpdatesText = EditorGUIUtility.TextContent ("EditorUpdateWindow.CheckForNewUpdatesText");
	}
