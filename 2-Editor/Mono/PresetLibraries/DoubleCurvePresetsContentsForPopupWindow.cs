...
class DoubleCurvePresetsContentsForPopupWindow : IPopupWindowContent
{
	...
	{
		DoubleCurvePresetLibrary doubleCurveDefaultLib = defaultPresetLibrary as DoubleCurvePresetLibrary;
		if (doubleCurveDefaultLib == null)
		{
			Debug.Log("Incorrect preset library, should be a DoubleCurvePresetLibrary but was a " + defaultPresetLibrary.GetType());
			return;
		}
